...
import s from './StatisticsComments.module.scss'

interface IProps {
  value: string
}

export const StatisticsCommentsMonth = ({ value }: IProps) => {
  ...
  return (
    <>
      <Tabs.Content value={value}>
        <Typography variant={'regular-text-16'}>{t.statisticsPage.comments}</Typography>
        <div className={s.chartDiv}>
          <LineChart
            color1={'rgba(57, 125, 246, 1)'}
            data3={data3}
            labels={labels}
